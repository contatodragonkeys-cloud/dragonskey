...
Write-Output "                   == DRAGONS KEY ==                   "
Write-Output "                     ____   ____                       "
Write-Output "                    / ___| / ___|                      "
Write-Output "               <`__/\___ \/\___ \                      "
Write-Output "               /____/\____/\____/                      "
Write-Output "                                                       "
Write-Output "  ______                                 _  __         "
Write-Output "  |  _  \                               | |/ /         "
Write-Output "  | | | | _ __  __ _   __ _   ___   _ __| ' /  ___ _   "
Write-Output "  | | | || '__|/ _` | / _` | / _ \ | '_ \  <  / _ \ |  "
Write-Output "  | |/ / | |  | (_| || (_| || (_) || | | . \ |  __/ |_ "
Write-Output "  |___/  |_|   \__,_| \__, | \___/ |_| |_\\_\\___|\__, |"
Write-Output "                       __/ |                       __/ |"
Write-Output "                      |___/                       |___/ "
Write-Output "                                                        "
